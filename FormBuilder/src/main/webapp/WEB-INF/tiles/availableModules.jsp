	        ...
	        <tr class="d1" >
              ...
              <td valign="middle">
	             <c:if test="${!current.library and (isAdmin or isDeployer and (current.status == 'APPROVED_FOR_PILOT' or current.status == 'APPROVED_FOR_PRODUCTION'))}">
	             	...
	             	<span style="display: inline-block; vertical-align:middle" class="exportModule" alt="Export '${current.description}'" title="Export '${current.description}'">
...
function generateModuleExportUrl(moduleId)
{
	...
	var exportModuleMarURL = "${moduleXMLExportUrl}?moduleId="+ moduleId+"&format=MAR";
