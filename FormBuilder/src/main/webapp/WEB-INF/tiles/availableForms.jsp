...
<c:set var="dnd" value="dnd"/>
</c:if>
 
<c:choose>
<c:when test="${!item.libraryForm}" >
<div class="jstree-grid-wrapper border" style="width:796px;">

<div class="jstree-grid-header jstree-grid-header-regular">
<span class="jstree-grid-header jstree-grid-header-cell jstree-grid-header-regular" style="display: inline-block; float: left; margin-left: 3px; width: 213px; padding: 1px 3px 2px 5px;"><h4>Name</h4></span>

<span class="jstree-grid-header jstree-grid-header-cell jstree-grid-header-regular" style="display: inline-block; float: left; margin-left: 0px; width: 70px; padding: 1px 3px 2px 5px;"><h4>Author</h4></span>
<span class="jstree-grid-separator jstree-grid-separator-regular jstree-grid-resizable-separator">&nbsp;</span>
<span class="jstree-grid-header jstree-grid-header-cell jstree-grid-header-regular" style="display: inline-block; float: left; margin-left: 0px; width: 85px; padding: 1px 3px 2px 5px;"><h4>Status</h4></span>
<span class="jstree-grid-separator jstree-grid-separator-regular jstree-grid-resizable-separator">
&nbsp;</span>
<span class="jstree-grid-header jstree-grid-header-cell jstree-grid-header-regular" style="display: inline-block; float: left; margin-left: 0px; width: 120px; padding: 1px 3px 2px 5px;"><h4>Last Update</h4></span>
<span class="jstree-grid-separator jstree-grid-separator-regular jstree-grid-resizable-separator">&nbsp;</span>
<span class="jstree-grid-header jstree-grid-header-cell jstree-grid-header-regular" style="display: inline-block; float: left; margin-left: 0px; width: 110px; padding: 1px 3px 2px 5px;"><h4>Last Update By</h4></span>
<span class="jstree-grid-separator jstree-grid-separator-regular jstree-grid-resizable-separator">&nbsp;</span>
<span class="jstree-grid-header jstree-grid-header-cell jstree-grid-header-regular" style="display: inline-block; float: left; margin-left: 0px; width: 30px; padding: 1px 3px 2px 5px;"></span>
<span class="jstree-grid-separator jstree-grid-separator-regular jstree-grid-resizable-separator">&nbsp;</span>
<span class="jstree-grid-header jstree-grid-header-cell jstree-grid-header-regular" style="display: inline-block; float: left; margin-left: 0px; width: 30px; padding: 1px 3px 2px 5px;"></span>
<span class="jstree-grid-separator jstree-grid-separator-regular jstree-grid-resizable-separator">&nbsp;</span>
<span class="jstree-grid-header jstree-grid-header-cell jstree-grid-header-regular" style="display: inline-block; float: left; margin-left: 0px; width: 30px; padding: 1px 3px 2px 5px;"></span>
...
<div id="tree" class="jstree jstree-1 jstree-focused jstree-classic" >

<!--  Iterate over the tree of nested forms for display -->
<c:set var="formNameColumnWidth" value="200"/>
<c:set var="forms" value="${moduleForms}" scope="request"/>
 <jsp:include page="formListRow.jsp">
 <jsp:param name="formNameColumnWidth" value="${formNameColumnWidth}"/>
 </jsp:include>

<!--  Logic that decides whether or not to show buttons for expanding and collapsing all --> 
<c:forEach items="${moduleForms}" var="item" varStatus="cnt">
<c:if test="${!item.libraryForm}">
<c:if test="${not empty item.children}">
	<c:set var="showButtons"
			value="true" />
</c:if>
</c:if>
</c:forEach>
...
<a style="width: 200px;" class="jstree-grid-col-0 " href="${questionListUrl}">${item.name}</a>
...
<!-- {item.endTag}-->
 ...
 <c:set var="parent" value="${item}" scope="request"/>
 <jsp:include page="formListRow.jsp">
 <jsp:param name="formNameColumnWidth" value="${formNameColumnWidth-20}"/>
 </jsp:include>
...
<script type="text/javascript">
	...
	$(function(){
		$("#tree").bind("move_node.jstree",function(event,data){
			 var src = data.rslt.o.attr("id");
			 var trg = data.rslt.r.attr("id");
			//alert('inside bind');
			
			FormListController.moveForms(src,trg, data.rslt.p,
					  {
				errorHandler:	function(errorString, exception) { 
				  alert('Unexpected error during move forms. Page will be reloaded.');
				  window.location.reload();
