		...
		<table class="border" width="800" border="0" cellpadding="0" cellspacing="0">
				<tr> 
		          ...
		          <td>
		          	...
		          	<span id="moduleSelectNote">(Note: Currently only handles <b>flat</b> modules)</span>
		          </td>
		        </tr>	
		        <tr>
		        ...
		        <tr> 
		          <td align="right"><span class="requiredAsterisk">*</span>Number of module instances per owner:</td>
		          <td><form:input path="numberOfModuleInstances"/></td>
		        </tr>
		        <tr> 
		          <td align="right"><span class="requiredAsterisk">*</span>Number of owners: </td>
		          <td><form:input path="numberOfEntities"/></td>
		        </tr>	
		        <tr> 
		          <td align="right"><span class="requiredAsterisk">*</span>Module context: </td>
				 ...
				 <c:forEach items="${ generatedModuleDataDetail.questionFields }" var="questionField" varStatus="status">
					...
					<tr id="row_${ questionField['uuid'] }" 
						...
						<td>
							...
							Owner Unique
							<span class="questionmark" title="No two owners can have the same combination of these fields.">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><br/>
							...
							Owner Specific
							<span class="questionmark" title="No two of an owner's modules can have the same combination of these fields. However, different owner could have the same combination of these fields.">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
							</span>
						</td>
					</tr>	 
				 </c:forEach>
