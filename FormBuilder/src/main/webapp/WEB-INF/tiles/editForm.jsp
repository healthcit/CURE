...
<script src="${appPath}/scripts/skipPattern.js" type="text/javascript"></script>
	...
	<table class="border editForm" width="800" border="0" cellpadding="0" cellspacing="0">
        ...
        <td align="left"><b>Parent Form:</b></td>
        <td align="left" colspan="3">    
        
        <form:select path="parent" cssStyle="width:230px" disabled="${!isEditable}">
        	<form:option value="0" label="Please Select" />
		    <form:options items="${moduleForms}" itemValue="id" itemLabel="name" />
		</form:select>       
         ...
         <tr><td colspan="4" height="5"></td></tr>
        <tr>        
        <td align="left"><b>Relationship Name:</b></td>
        <td align="left" colspan="3"> 
        <form:input path="relationshipName" disabled="${!isEditable}"/>&nbsp;    
		</td>		
        </tr>
        <tr><td colspan="4" height="5"></td></tr>
        <tr>        
        <td align="left"><b>Multiple Instances:</b></td>
        <td align="left" colspan="3">           
    		<form:checkbox path="multipleInstances" disabled="${!isEditable}" />          
		  </td>		
        </tr>
       </c:if>
		<tr><td colspan="4" height="5"></td></tr>
