...
public class GeneratedModuleDataDetail {
	 ...
	 */
	private Integer actualNumberOfCouchDbForms = null;
	...
	public Integer getActualNumberOfCouchDbForms() {
		return actualNumberOfCouchDbForms;
	}

	public void setActualNumberOfCouchDbForms(
			Integer actualNumberOfCouchDbForms) {
		this.actualNumberOfCouchDbForms = actualNumberOfCouchDbForms;
	}
	...
	private void calculateActualNumberOfModulesAndEntities()
	{
		...
		// re-calculate the actual number of modules based on the number of modules per entity
