...
public class ModuleDao {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<Module> getFlatModuleList() {
		Query query = em.createQuery("select m from Module m where m not in " +
				"(select f.module from QuestionnaireForm f where f.parent is not null or f.multipleInstances = true) " +
