            ...
            <xsl:element name="div">
                ...
                <xsl:element name="div">
                    ...
                    <xsl:for-each select="modules/module">
                        ...
                        <xsl:variable name="availableActions" select="@availableActions"/>
                        <xsl:variable name="isSubmittable" select="contains($availableActions,'SUBMIT')"/>  
                        ...
                        <xsl:element name="p" >
                            <xsl:attribute name="class">finish</xsl:attribute>
                            <xsl:if test="not($status='completed') and ($isSubmittable)">
                                <xsl:element name="a" >
                                    <xsl:attribute name="href">/management/submit-module/<xsl:value-of select="$id"/></xsl:attribute>
                                    <xsl:attribute name="title">Submit</xsl:attribute>
