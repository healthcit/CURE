...
SET MAIN_JOB=PreProcess\ConvertXMLs.kjb
...
call kitchen.bat /file:%JOB% /param:PROPERTIES="%PROPERTIES%" -level=Detailed -log=C:\Users\madhava\Desktop\WORK\convert.log
