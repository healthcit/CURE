...
SET MAIN_JOB=PreProcess\Validate.kjb
...
call kitchen.bat /file:%JOB% /param:PROPERTIES="%PROPERTIES%" -level=Detailed -log=C:\Users\madhava\Desktop\WORK\validate.log
