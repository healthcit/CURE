...
@Component
public class UpdateCacureDesignDoc  extends SystemUpdaterImpl{
	private Logger log = Logger.getLogger(UpdateCacureDesignDoc.class);
	...
	public void executeUpdate() throws Exception {
		String content = IOUtils.read( this.getClass().getResourceAsStream("UpdateCacureDesignDoc.txt") );
