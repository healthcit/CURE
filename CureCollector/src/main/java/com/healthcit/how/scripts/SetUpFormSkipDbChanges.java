...
@Component
public class SetUpFormSkipDbChanges  extends SystemUpdaterImpl{
	private Logger log = Logger.getLogger(SetUpFormSkipDbChanges.class);
	...
	public void executeUpdate() throws Exception {
		String content = IOUtils.read( this.getClass().getResourceAsStream("SetUpFormSkipDbChanges.txt") );
